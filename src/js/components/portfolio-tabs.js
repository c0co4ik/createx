...
const portfolioTabsBtn = document.querySelectorAll('.portfolio-tabs-nav__btn');
...
portfolioTabsNav.addEventListener('click', (e) => {
  ...
  if (target.classList.contains('portfolio-tabs-nav__btn')){
    ...
    portfolioTabsBtn.forEach(el => { el.classList.remove('portfolio-tabs-nav__btn--active')});
...
loadMore.addEventListener('click', (e) => {
  const visibleItems = document.querySelectorAll('.portfolio-tabs__item');
